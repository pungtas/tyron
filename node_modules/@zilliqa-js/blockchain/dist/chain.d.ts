...
import { BlockchainInfo, BlockList, DsBlockObj, PendingTxnResult, PendingTxns, Provider, RPCResponse, ShardingStructure, TransactionObj, MinerInfo, TxBlockObj, TxList, ZilliqaModule } from '@zilliqa-js/core';
