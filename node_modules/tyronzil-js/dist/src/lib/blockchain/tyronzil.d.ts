...
export default class TyronZIL extends ZilliqaInit {
    ...
    static initialize(network: NetworkNamespace, initTyron: InitTyron, userPrivateKey: string, gasLimit: string): Promise<TyronZIL>;
    /***            ****            ***/
    /** Deploys the DIDC by version
     * & calls the Init transition with the avatar.agent */
    static deploy(input: TyronZIL, version: string): Promise<DeployedContract>;
