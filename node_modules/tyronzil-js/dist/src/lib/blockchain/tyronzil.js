...
const ErrorCode_2 = __importDefault(require("../decentralized-identity/util/ErrorCode"));
...
class TyronZIL extends zilliqa_init_1.default {
    ...
    static deploy(input, version) {
        return __awaiter(this, void 0, void 0, function* () {
            const deployed_contract = yield smart_util_1.default.decode(input.API, input.initTyron, version)
                .then(contract_code => {
                console.log(log_colors_1.default.brightGreen(`DIDC-code successfully downloaded & decoded from the init.tyron smart contract!`));
                const CONTRACT_INIT = [
                    {
                ...
                console.log(log_colors_1.default.yellow(`The user's DIDC got properly instantiated: `) + log_colors_1.default.brightYellow(`${JSON.stringify(contract, null, 2)}`));
                ...
                console.log(log_colors_1.default.yellow(`The user's Tyron DID smart contract (DIDC) is deployed: `) + log_colors_1.default.brightYellow(`${IS_DEPLOYED}`));
                console.log(log_colors_1.default.yellow(`Its Zilliqa address is: `) + log_colors_1.default.brightYellow(`${didc.address}`));
                ...
                console.log(log_colors_1.default.yellow(`Gas consumed by deploying the DIDC was: `) + log_colors_1.default.brightYellow(`${DEPLOYMENT_GAS}`));
                ...
                console.log(log_colors_1.default.brightGreen(`Calling the Init transition...`));
                const agent = "pungtas";
                const CALL = yield deployed_contract.contract.call('Init', [
                    {
                        vname: 'agent',
                        type: 'String',
                        value: `${agent}`
                ...
                console.log(log_colors_1.default.yellow(`The user's DIDC is initialized: `) + log_colors_1.default.brightYellow(`${CALL.isConfirmed()}`));
                const CUMULATIVE_GAS = (CALL.getReceipt()).cumulative_gas;
                console.log(log_colors_1.default.yellow(`Gas consumed by the Init transition was: `) + log_colors_1.default.brightYellow(`${CUMULATIVE_GAS}`));
                console.log(log_colors_1.default.yellow(`The transaction ID is: `) + log_colors_1.default.brightYellow(`${CALL.id}`));
                if (!CALL.isConfirmed()) {
    ...
    static submit(input, didcAddr, tag, params, operation // e.g. ".did"
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield input.API.blockchain.getSmartContractState(didcAddr)
                ...
                if (STATUS) {
                    console.log(log_colors_1.default.brightGreen(`The ${tag} tyronZIL transaction was successful!`));
                }
                else {
                    console.log(log_colors_1.default.red(`The ${tag} tyronZIL transaction was unsuccessful!`));
                }
                const TX_RECEIPT = transaction.getReceipt();
                const CUMULATIVE_GAS = TX_RECEIPT.cumulative_gas;
                console.log(log_colors_1.default.yellow(`Gas consumed: `) + log_colors_1.default.brightYellow(`${CUMULATIVE_GAS}`));
            }))
                .catch(err => { throw err; });
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (element) {
                ...
                case document_model_1.DocumentElement.Service:
                    ...
                    break;
                default:
                    throw new ErrorCode_2.default("UnsupportedElement", "That is not a DID-Document supported element");
            }
            return VALUE;
        });
    }
