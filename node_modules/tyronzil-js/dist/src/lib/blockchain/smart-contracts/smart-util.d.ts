...
export default class SmartUtil {
    ...
    static encode(): Promise<void>;
    /** Fetches the `Tyron DID-Smart-Contract` by version & decodes it */
    static decode(api: API.Zilliqa, initTyron: InitTyron, contractVersion: string): Promise<string>;
    /** Gets the value out of a DIDC field Option */
    static getValue(object: any): Promise<string>;
    /** Gets the DID-Status out of a DIDC field Option */
    static getStatus(object: any): Promise<string>;
    /** Gets the value out of a map key */
    static getValuefromMap(object: any, key: string): Promise<any>;
    /** Turns the smart contract's map into a Map */
    static intoMap(object: any): Promise<Map<string, any>>;
    /** Turns the DIDC `services` map field into a Map */
    static fromServices(object: any): Promise<Map<string, [string, string]>>;
}
