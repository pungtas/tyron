...
class DidUpdate {
    constructor(operation) {
        this.type = sidetree_1.OperationType.Update;
    ...
    static execute(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const operation = yield sidetree_1.Sidetree.processPatches(input.patches)
                ...
                const [NEW_UPDATE_KEY, NEW_UPDATE_PRIVATE_KEY] = yield did_keys_1.Cryptography.keyPair("update");
                update.privateKeys.push(NEW_UPDATE_PRIVATE_KEY);
                const PRIVATE_KEYS = yield did_keys_1.Cryptography.processKeys(update.privateKeys);
