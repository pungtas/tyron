    ...
    static write(did, input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.info(log_colors_1.default.yellow(`DID resolved as: ${log_colors_1.default.brightYellow(FILE_NAME)}`));
            }
            catch (error) {
                throw new ErrorCode_1.default("CodeCouldNotSave", "The DID file did not get saved");
            }
        });
    }
}
